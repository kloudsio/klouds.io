...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = {};
	Component.layout = __webpack_require__(2);
	Component.apps = __webpack_require__(3);

	Component.layout.init();
	Component.apps.init();

	var describe = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function login(data) {
		var res;
		return regeneratorRuntime.wrap(function login$(context$1$0) {
			while (1) switch (context$1$0.prev = context$1$0.next) {
				case 0:
					context$1$0.next = 2;
					return qwest.post('/user/login', data, state.qwest);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function anonymous(locals, filters, escape, rethrow) {
	    ...
	    var __stack = {
	        lineno: 1,
	        input: '<% for (var i = 0; i < apps.length; i++) { %>\n	<button name="button"><%= apps[i].title %> </button>\n<% } %>\n',
	        filename: "."
	    };
	    function rethrow(err, str, filename, lineno) {
	        var lines = str.split("\n"), start = Math.max(lineno - 3, 0), end = Math.min(lines.length, lineno + 3);
	        ...
	        with (locals || {}) {
	            (function() {
	                ...
	                for (var i = 0; i < apps.length; i++) {
	                    buf.push('\n	<button name="button">', escape((__stack.lineno = 2, apps[i].title)), " </button>\n");
	                    __stack.lineno = 3;
	                }
	                buf.push("\n");
	            })();
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/home/dsont/dev/microgrid/front-end/client/node_modules/css-loader/index.js!/home/dsont/dev/microgrid/front-end/client/src/components/styles/layout.css", function() {
			var newContent = require("!!/home/dsont/dev/microgrid/front-end/client/node_modules/css-loader/index.js!/home/dsont/dev/microgrid/front-end/client/src/components/styles/layout.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		module.hot.accept("!!/home/dsont/dev/microgrid/front-end/client/node_modules/css-loader/index.js!/home/dsont/dev/microgrid/front-end/client/src/components/styles/typography.css", function() {
			var newContent = require("!!/home/dsont/dev/microgrid/front-end/client/node_modules/css-loader/index.js!/home/dsont/dev/microgrid/front-end/client/src/components/styles/typography.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
		// When the module is disposed, remove the <style> tags
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                = __webpack_require__(79)
	  ...
	  , arrayMethod      = __webpack_require__(84)
	  , IE_PROTO         = __webpack_require__(85).safe('__proto__')
	  , assert           = __webpack_require__(86)
	...
	$def($def.P, 'String', {trim: __webpack_require__(88)(/^\s*([\s\S]*\S)?\s*$/, '$1')});
	...
	var date       = new Date(-5e13 - 1)
	  , brokenDate = !(date.toISOString && date.toISOString() == '0385-07-25T07:06:39.999Z'
	      && __webpack_require__(89)(function(){ new Date(NaN).toISOString(); }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	$.each.call((
	    ...
	    var sym = __webpack_require__(92)(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'Object', {assign: __webpack_require__(93)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(82);
	$def($def.S, 'Object', {setPrototypeOf: __webpack_require__(94).set});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $   = __webpack_require__(79)
	  , cof = __webpack_require__(81)
	  , tmp = {};
	tmp[__webpack_require__(92)('toStringTag')] = 'z';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def    = __webpack_require__(82)
	  , toIndex = __webpack_require__(79).toIndex
...
/***/ function(module, exports, __webpack_require__) {
	...
	var set   = __webpack_require__(79).set
	  , $at   = __webpack_require__(95)(true)
	  , ITER  = __webpack_require__(85).safe('iter')
	  , $iter = __webpack_require__(96)
	  , step  = $iter.step;
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P + $def.F * !__webpack_require__(89)(function(){ 'q'.endsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// should throw error on regex
	$def($def.P + $def.F * !__webpack_require__(89)(function(){ 'q'.startsWith(/./); }), 'String', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(97)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	if($.FW && $.DESC){
	  ...
	  if(/./g.flags != 'g')$.setDesc(proto, 'flags', {
	    configurable: true,
	    get: __webpack_require__(88)(/^.*\/(\w*)$/, '$1')
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(79)
	  ...
	  , setProto = __webpack_require__(94).set
	  , species  = __webpack_require__(102)
	  , SPECIES  = __webpack_require__(92)('species')
	  , RECORD   = __webpack_require__(85).safe('record')
	  , PROMISE  = 'Promise'
	  , global   = $.g
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeakMap = __webpack_require__(106)('WeakMap', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(82);
	$def($def.S, 'RegExp', {
	  escape: __webpack_require__(88)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStatics(keys, length){
	  $.each.call(keys.split(','), function(key){
	    ...
	    else if(key in [])statics[key] = __webpack_require__(98)(Function.call, [][key], length);
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(55);
	var $           = __webpack_require__(79)
	  , Iterators   = __webpack_require__(96).Iterators
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(111)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	uid.safe = __webpack_require__(79).g.Symbol || uid;
	module.exports = uid;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(name){
	  return store[name] || (store[name] =
	    global.Symbol && global.Symbol[name] || __webpack_require__(85).safe('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                 = __webpack_require__(79)
	  , cof               = __webpack_require__(81)
	  , assertObject      = __webpack_require__(86).obj
	  , SYMBOL_ITERATOR   = __webpack_require__(92)('iterator')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertFunction = __webpack_require__(86).fn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertObject = __webpack_require__(86).obj;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(92)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $           = __webpack_require__(79)
	  , UNSCOPABLES = __webpack_require__(92)('unscopables');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx  = __webpack_require__(98)
	  , get  = __webpack_require__(96).get
	  , call = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(79)
	  ...
	  , assert   = __webpack_require__(86)
	  , forOf    = __webpack_require__(103)
	  , step     = __webpack_require__(96).step
	  , has      = $.has
	  , set      = $.set
	  , isObject = $.isObject
	  , hide     = $.hide
	...
	module.exports = {
	  ...
	  setIter: function(C, NAME, IS_MAP){
	    __webpack_require__(97)(C, NAME, function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $     = __webpack_require__(79)
	  , $def  = __webpack_require__(82)
	  , BUGGY = __webpack_require__(96).BUGGY
	  , forOf = __webpack_require__(103)
	  , species = __webpack_require__(102)
	  , assertInstance = __webpack_require__(86).inst;
	...
	module.exports = function(NAME, methods, common, IS_MAP, IS_WEAK){
	  ...
	  if(!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)){
	    ...
	    if(!__webpack_require__(100)(function(iter){ new C(iter); })){ // eslint-disable-line no-new
	      C = function(){
	  ...
	  __webpack_require__(81).set(C, NAME);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $      = __webpack_require__(79)
	  , invoke = __webpack_require__(83)
	  , assertFunction = __webpack_require__(86).fn;
